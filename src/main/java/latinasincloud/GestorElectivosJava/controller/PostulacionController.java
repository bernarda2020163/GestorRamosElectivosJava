...
import latinasincloud.GestorElectivosJava.service.PostulacionService;
...
public class PostulacionController {
     ...
     */
    @PostMapping
    public ResponseEntity<Postulacion> crearPostulacion(
            @RequestParam int estudianteId,
            @RequestParam int electivoId) {

        Postulacion nuevaPostulacion = postulacionService.crearPostulacion(estudianteId, electivoId);
